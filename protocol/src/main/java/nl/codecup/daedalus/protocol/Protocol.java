...
public class Protocol{
	...
	//Addresses
	public static byte ADDRESS_UNKNOWN = 0x00;
	public static byte ADDRESS_DAEDALUS = 0x01;
	public static byte ADDRESS_MANAGER = 0x02;
	public static byte ADDRESS_REFEREE = 0x03;
	public static byte ADDRESS_PLAYER = 0x04;

	public static byte ACTION_LOG = (byte) 0xFF;
